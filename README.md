...
projects/covid-mvmnt-2024-440720/assets/ml_hfp_cogs| mlHFI_prediction | 0 (only band) | ml_hfp | [A machine-learning approach to human footprint index estimation with applications to sustainable development](https://iopscience.iop.org/article/10.1088/1748-9326/abe00a). Resolution = 300m, spans 1999 - 2024, most receltnly updated in 2026. Converted annual rasters into COGs and uploaded as a custom GEE collection under our account. See closed [issue](https://github.com/ryoliver-lab/mortality-db/issues/83) for processing details and [qmd](https://github.com/ryoliver-lab/mortality-db/blob/main/code/dev/ml_HFP/ml_HFP.qmd) for comparison to other HFP dataset. 

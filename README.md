...
projects/covid-mvmnt-2024-440720/assets/ml_hfp_cogs| mlHFI_prediction | 0 (only band) | ml_hfp | Resolution = 300m, Machine learning derived human footprint dataset spanning 1999 - 2024, released in 2026. Converted into COGs and uploaded as a custom GEE collection under our account. See closed [issue](https://github.com/ryoliver-lab/mortality-db/issues/83) for processing details and [qmd](https://github.com/ryoliver-lab/mortality-db/blob/main/code/dev/ml_HFP/ml_HFP.qmd) for comparison to other HFP dataset. 
